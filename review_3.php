				...
				<div class="container">
					<div class="page">
						...
						<div class="movie-list">
							<?php
							$get_movie = "SELECT * FROM movie_name WHERE id BETWEEN 17 AND 24";
							$run_movie = mysqli_query($con, $get_movie);
						...
						<div class="pagination">
							<a href="review_2.php" class="page-number prev"><i class="fa fa-angle-left"></i></a>
							<a href="review.php"><span class="page-number">1</span></a>
							<a href="review_2.php"> <span class="page-number">2</span></a>
							<a> <span class="page-number current">3</span></a>
			...
			<footer class="site-footer">
				<div class="container">
					<div class="row">
						...
						<div class="colophon"> © Copyright 2016 Meta Critic. All rights reserved</div>
					</div> <!-- .container -->
