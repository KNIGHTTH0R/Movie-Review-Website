...
include("db.php");
error_reporting(0);
$movie_filter = $_GET['movie_filter'];
$id1 = $movie_filter;
$id2 = $movie_filter + 1;
?>
    ...
    <main class="main-content">
        <div class="container">
            <div class="page">
                ...
                <!--
                <div class="filters">
                    <select name="artist_filter" id="filter_id">
                        <?php
                /*$get_painting = "SELECT DISTINCT artist FROM paintings";
                $run_painting = mysqli_query($con, $get_painting);

                echo "<option name=\"default\" disabled>Filter by artist</option>";

                while ($row_painting = mysqli_fetch_array($run_painting)) {
                    $artist = $row_painting['artist'];

                    echo "
                        <option name=\"https://www.google.co.in/\">$artist</option>
                        ";
                }*/
                ?>
                    </select>
                    <select name="country_filter" placeholder="Choose Country">
                        <?php
                /*$get_painting = "SELECT DISTINCT country FROM paintings";
                $run_painting = mysqli_query($con, $get_painting);

                while ($row_painting = mysqli_fetch_array($run_painting)) {
                    $country = $row_painting['country'];
                    $id = $row_painting['id'];

                    echo "
                    <option value=\"$country\"><a href='#'>$country</a></option>
                    ";
                }*/
                ?>
                    </select>
                ...
                <div class="movie-list">
                    ...
                    $get_movie = "SELECT * FROM movie_name WHERE id = $id1 OR id = $id2";
                ...
                <div class="pagination">
                    ...
                    <a href="review2.php" class="page-number">2</a>
                    <a href="review3.php" class="page-number">3</a>
                    <a href="review2.php" class="page-number next"><i class="fa fa-angle-right"></i></a>
                </div>
                -->
            </div>
        </div> <!-- .container -->
