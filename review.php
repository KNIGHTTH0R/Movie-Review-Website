				...
				<div class="container">
					<div class="page">
						...
						<div class="movie-list">
							<?php
							$get_movie = "SELECT * FROM movie_name WHERE id BETWEEN 1 AND 8";
							$run_movie = mysqli_query($con, $get_movie);
						...
						<div class="pagination">
							<a class="page-number prev"><i class="fa fa-angle-left"></i></a>
							<span class="page-number current">1</span>
							<a href="review_2.php" class="page-number">2</a>
							<a href="review_3.php" class="page-number">3</a>
							<a href="review_2.php" class="page-number next"><i class="fa fa-angle-right"></i></a>
						</div>
					</div>
				</div> <!-- .container -->
			</main>
